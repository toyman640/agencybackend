...
from .views import RegisterUserView, RegisterStaffUserView, RegisterSuperUserView, LoginView, LogoutView, ActivateUserView, DeactivateUserView, StaffUsersView, AgencyView, EditAgencyView, NonStaffUsersView
...
urlpatterns = [
  ...
  path('users/non-staff/', NonStaffUsersView.as_view(), name='non-staff-users'),
]
